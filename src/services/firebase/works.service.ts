...
import { WorkSchema, type Work } from "@/types";
import {
  createDocument,
  fetchDocuments,
  formatError,
...
import { deleteSong, getSongsByWork } from "./songs.service";
...
export const getAllWorks = async (): Promise<ServiceResponse<Work[]>> => {
  try {
    ...
    return {
      success: false,
      error: formatError(error, "Erreur lors du chargement des oeuvres"),
    };
  }
};
...
export const addWork = async (
  ...
  try {
    ...
    return {
      success: false,
      error: formatError(error, "Erreur lors de la creation de l'oeuvre"),
    };
  }
};
...
export const updateWork = async (
  ...
  try {
    ...
    return {
      success: false,
      error: formatError(error, "Erreur lors de la mise a jour de l'oeuvre"),
    };
  }
};
...
export const deleteWork = async (id: string): Promise<ServiceResponse> => {
  try {
    ...
    return {
      success: false,
      error: formatError(error, "Erreur lors de la suppression de l'oeuvre"),
    };
  }
};
...
export const reorderWorks = async (
  ...
  try {
    ...
    return {
      success: false,
      error: formatError(error, "Erreur lors du tri des oeuvres"),
    };
  }
};
