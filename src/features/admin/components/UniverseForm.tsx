...
import { UniverseFormSchema, type UniverseFormValues } from "@/features/admin/validation/admin";
...
export const UniverseForm = ({
  ...
  const [selectedCategory, setSelectedCategory] = useState<IconCategoryId>(initialCategory);
  ...
  const {
    ...
    defaultValues: {
      ...
      color: universe?.color || DEFAULT_COLOR,
      icon: universe?.icon || DEFAULT_ICON,
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      ...
      <div>
            ...
            {selectedIcon && (
              <>
                ...
                <div>
                  ...
                  <div className="text-[var(--color-text-secondary)] text-sm">Icone selectionnee</div>
                </div>
              </>
            )}
          </div>
        ...
        {errors.icon && <p className="text-red-600 text-sm mt-2">{errors.icon.message}</p>}
      </div>
