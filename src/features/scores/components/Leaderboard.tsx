...
type RankedPlayer = RoomPlayer & { rank?: number };
...
const LeaderboardRow = memo(({ player, isCurrentPlayer, rank }: LeaderboardRowProps) => {
  ...
  return (
    <motion.div
      ...
      className={`relative flex items-center gap-4 px-4 py-3 rounded-xl ${rowClasses}`}
    >
