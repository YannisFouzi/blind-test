...
const GameStageComponent = ({ children, player }: GameStageProps) => {
  return (
    <div className="h-screen h-[100svh] bg-[var(--color-surface-base)] relative overflow-hidden overscroll-none">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-200/40 via-transparent to-blue-200/40 pointer-events-none z-0" />
      ...
      {/* Two-zone layout: scrollable content above, fixed player at the bottom. */}
