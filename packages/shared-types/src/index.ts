...
const playlistUrlSchema = z.preprocess(
  trimToUndefined,
  z.union([z.string().url("URL invalide"), playlistIdSchema]).optional()
);
...
export const SongSchema = z.object({
  ...
  // Pre-generated reverse audio URL (optional for older docs).
  audioUrlReversed: optionalUrlSchema,
...
export const WorkSchema = z.object({
  ...
  playlistId: optionalTrimmedStringSchema,
...
export const GameSessionSchema = z.object({
  ...
  // Round model fields for solo mode.
...
export const RoomPlayerSchema = z.object({
  ...
  // Starting phase: true after player_ready.
